    ...
    class="flex h-screen overflow-hidden">
        ...
        >
            ...
            <div class="flex items-center justify-between h-20 px-6 border-b  border-gray-200">
                ...
                <button 
                    @click="sidebarOpen = false"
                    class="md:hidden text-gray-600 hover:text-etagate-orange focus:outline-none transition-colors duration-200"
                >
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'dashboard' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                ...
                                <svg :class="activeItem === 'dashboard' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'modelos' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'modelos' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'procesos' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'procesos' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'ejecutar' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'ejecutar' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'historial' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'historial' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'encuestas' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'encuestas' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        >
                            <div :class="activeItem === 'configuracion' ? 'bg-white bg-opacity-20' : 'bg-gray-100 group-hover:bg-etagate-orange group-hover:bg-opacity-10'" 
                                 class="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300">
                                <svg :class="activeItem === 'configuracion' ? 'text-white' : 'text-gray-600 group-hover:text-etagate-orange'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between">
                            <div class="md:w-1/2 mb-8 md:mb-0">
                                ...
                                <p class="text-gray-300 text-lg mb-8">
                                    Eliminate manual errors, accelerate workflows, and maintain consistent quality across all global operations
                                </p>
                                
                                <div class="space-y-6">
                                    <div class="flex items-start">
                                        <div class="w-12 h-12 bg-etagate-orange rounded-full flex items-center justify-center flex-shrink-0">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                        </div>
                            ...
                            <div class="md:w-1/2 md:pl-12">
                                <div class="bg-gradient-to-br from-white to-gray-100 rounded-2xl p-12 text-center shadow-2xl border-4 border-etagate-orange border-opacity-30">
                                    <h3 class="text-7xl font-bold bg-gradient-to-r from-etagate-blue to-etagate-orange bg-clip-text text-transparent mb-4">
                                        700M+
                                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <p class="text-4xl font-bold bg-gradient-to-r from-etagate-blue to-etagate-orange bg-clip-text text-transparent">124</p>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="w-12 h-12 bg-gradient-to-br from-etagate-orange to-orange-600 rounded-xl flex items-center justify-center shadow-lg">
                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                                    </svg>
                                </div>
                            </div>
                            <p class="text-4xl font-bold bg-gradient-to-r from-etagate-blue to-etagate-orange bg-clip-text text-transparent">18</p>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <p class="text-4xl font-bold bg-gradient-to-r from-etagate-blue to-etagate-orange bg-clip-text text-transparent">45</p>
